...
const styles = {
  ...
  solid: [
    ...
    "before:absolute before:inset-0 before:-z-10 before:rounded-[calc(theme(borderRadius.3xl)-1px)] before:bg-[--btn-bg]",
    ...
    "after:absolute after:inset-0 after:-z-10 after:rounded-[calc(theme(borderRadius.3xl)-1px)]",
